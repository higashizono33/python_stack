...
SELECT countries.name, COUNT(*) AS "total_number_cities" FROM countries
...
-- 6. What query would you run to get countries with only Constitutional Monarchy with a capital greater than 
...
-- 7. What query would you run to get all the cities of Argentina inside the Buenos Aires district and have 
-- the population greater than 500, 000? The query should return the Country Name, City Name, District and 
-- Population. (2)
...
SELECT region, COUNT(*) AS "number_countries" FROM countries
GROUP BY region
ORDER BY COUNT(*) DESC;
