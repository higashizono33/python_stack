...
# print: 0, 7, 1, 13, 2, 8, 3, 42 print "The answer to life, the universe, and everything."
...
#     else:
#         print(num)
# print: "Hello", 1, "Hello", 3, "Hello", 5, "Hello", 7, "Hello", 9
...
#     else:
#         print(num)
# print: "Hello", 1, "World", 3, "Hello", 5, "World", 7, "Hello", 9
...
#     print(key)
#     print(pet_info[key])
# print: "name", "Fido", "age", 4, "trick", "rolls over"
...
# print: "First, I will use the 20 minute rule and use the platform and other resources to find my answer"
